	...
	drowHeader = function(){
		...
		for(i=0;i<cols.length;i++){
			...
			if(!col.checkbox){
				...
				s += "<td align='" + (col.headerAlign || _config.headerAlign || "center") + "' width='" + (col.width || "") + "'>" +(col.headerText || "") + '<input type="checkbox" />'  + "</td>";	
			}
		}
		s += "</tr>";
	}
...
//公共静态变量
TreeGrid.FOLDER_OPEN_ICON = "themes/default/images/tree_folder_open.gif";
TreeGrid.FOLDER_CLOSE_ICON = "themes/default/images/tree_folder.gif";
TreeGrid.DEFAULT_LEAF_ICON = "themes/default/images/tree_file.gif";
TreeGrid.COUNT = 1;
