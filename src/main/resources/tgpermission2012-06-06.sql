...
insert  into `c_action`(`id`,`name`,`enname`,`handler`,`icon`,`status`,`orderid`,`memo`) values (1,'æ–°å¢','add','add()','','status100',1,''),(4,'åˆ é™¤','delete','delete()','','status100',2,''),(5,'ä¿®æ”¹','modify','modify()','','status100',3,''),(7,'æŸ¥è¯¢','query','query()','','status100',7,''),(8,'å®¡æ ¸','validate','validate()','','status100',8,''),(10,'åˆ·æ–°','refresh','refresh()','','status100',9,''),(11,'é«˜çº§æŸ¥è¯¢','advanceQuery','','','status100',10,''),(12,'æŸ¥çœ‹','detail','','','status100',11,''),(13,'æ·»åŠ æ“ä½œ','addOperation','','','status100',12,''),(14,'åˆ†é…èµ„æº','assignResource','','','status100',13,''),(15,'åˆ†é…æ“ä½œ','assignAction','','','status100',14,''),(16,'æ·»åŠ ç”¨æˆ·','addUser','','','status100',15,''),(17,'åˆ é™¤ç»„å†…ç”¨æˆ·','deleteGroupUser','','','status100',16,''),(18,'ç»„æˆæƒè§’è‰²','groupAuthRole','','','status100',17,''),(19,'æŸ¥çœ‹ç»„æ‹¥æœ‰çš„è§’è‰²','detailGroupRole','','','status100',18,''),(20,'ç§»é™¤ç»„æ‹¥æœ‰çš„è§’è‰²','removeGroupRole','','','status100',19,''),(21,'æ–°å¢æµç¨‹','addFlow','','','status100',20,'');
