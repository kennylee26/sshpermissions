/**   
  * @Title: SpringHandler.java 
  * @Package com.tgyt.framework.dao.hspring.handler.imp.spring 
  * @Description: 
...
//		return allCount;
	...
	/** 
	  ...
	  * @Description: 得到当前使用的session
	  * @return Session 得到当前session
	  * @throws 
	  */
